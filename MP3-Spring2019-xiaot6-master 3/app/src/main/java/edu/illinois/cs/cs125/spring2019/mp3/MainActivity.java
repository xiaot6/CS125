...
public final class MainActivity extends AppCompatActivity {
    ...
    protected void finishProcessImage(final String jsonResult) {
         ...
         * and deal with Rick. Mark
         */
        final ImageView catview = findViewById(R.id.xyz);
        final ImageView dogview = findViewById(R.id.chuchu);
        final TextView caption = findViewById(R.id.textView2);
        final ImageButton processImage = findViewById(R.id.processImage);
        final TextView meta = findViewById(R.id.textView);
        caption.setText(RecognizePhoto.getCaption(jsonResult));
        meta.setText(description);
        catview.setVisibility(View.GONE);
        caption.setVisibility(View.VISIBLE);
        dogview.setVisibility(View.GONE);
        meta.setVisibility(View.VISIBLE);
        //processImage.setOnClickListener(v -> {
        if (RecognizePhoto.isACat(jsonResult, RECOGNITION_THRESHOLD) == true) {
            catview.setVisibility(View.VISIBLE);
            //caption.setVisibility(View.VISIBLE);
            //meta.setVisibility(View.VISIBLE);
                //dogview.setVisibility(View.GONE);
        }
        if (RecognizePhoto.isADog(jsonResult, RECOGNITION_THRESHOLD) == true) {
            dogview.setVisibility(View.VISIBLE);
            //caption.setVisibility(View.VISIBLE);
            //meta.setVisibility(View.VISIBLE);
                //catview.setVisibility(View.GONE);
        }
    ...
    void updateCurrentBitmap(final Bitmap setCurrentBitmap, final boolean resetInfo) {
        ...
        if (resetInfo) {
            ImageView catview = findViewById(R.id.xyz);
            ImageView dogview = findViewById(R.id.chuchu);
            TextView caption = findViewById(R.id.textView2);
            ImageButton processImage = findViewById(R.id.processImage);
            TextView meta = findViewById(R.id.textView);
            caption.setText("");
            meta.setText("");
            catview.setVisibility(View.GONE);
            dogview.setVisibility(View.GONE);
